...
![Version: 0.4.0](https://img.shields.io/badge/Version-0.4.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 24.3.1](https://img.shields.io/badge/AppVersion-24.3.1-informational?style=flat-square)
...
| duckling.image.tag | string | `"24.3.1"` | Docker image tag |
...
| kotlinCompiler.image.tag | string | `"24.3.1"` | Docker image tag |
...
| nlpApi.image.tag | string | `"24.3.1"` | Docker image tag |
