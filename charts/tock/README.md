...
| adminWeb.image.tag | string | `"24.3.2"` | Docker image tag |
...
| botApi.image.tag | string | `"24.3.2"` | Docker image tag |
...
| buildWorker.image.tag | string | `"24.3.2"` | Docker image tag |
...
| duckling.image.tag | string | `"24.3.2"` | Docker image tag |
...
| genAiOrchestrator.image.tag | string | `"24.3.2"` | Docker image tag |
...
| kotlinCompiler.image.tag | string | `"24.3.2"` | Docker image tag |
...
| nlpApi.image.tag | string | `"24.3.2"` | Docker image tag |
